...
export default class Products extends Component{
    ...
    showAddForm(){
        this.animateElement.style.display='block';
    ...
    render(){
        return (
          <article className="cj-product container">
              <h2>Products list</h2>
              ...
              <Button onClick={()=>this.showAddForm()}><Glyphicon glyph="plus"/>Add Data</Button>
              <form ref={(ref)=>this.animateElement=ref} style={{display:'none'}}>
